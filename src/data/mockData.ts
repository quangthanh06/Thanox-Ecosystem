...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    packages: [
      { id: 'pkg-1-1', name: '1 THÁNG', price: 49000, originalPrice: 70000, sellerPrice: 30000, keys: 'Key 1 Tháng: TX-AND-1M-9988' },
      { id: 'pkg-1-2', name: '3 THÁNG', price: 89000, originalPrice: 120000, sellerPrice: 55000, keys: 'Key 3 Tháng: TX-AND-3M-4455' },
      { id: 'pkg-1-3', name: '1 NĂM', price: 149000, originalPrice: 200000, sellerPrice: 95000, keys: 'Key 1 Năm: TX-AND-1Y-7766' },
      { id: 'pkg-1-4', name: 'VĨNH VIỄN', price: 199000, originalPrice: 300000, sellerPrice: 130000, keys: 'Key Vĩnh Viễn: TX-AND-LIFETIME-VIP' },
    ],
  },
  {
    id: 'prod-2',
    ...
    packages: [
      { id: 'pkg-2-1', name: 'BẢN BASIC', price: 49000, originalPrice: 80000, sellerPrice: 30000, keys: 'Link Tải Basic: https://drive.google.com/file/d/magisk-basic' },
      { id: 'pkg-2-2', name: 'BẢN VIP EXTREME', price: 89000, originalPrice: 150000, sellerPrice: 55000, keys: 'Link Tải VIP Extreme: https://drive.google.com/file/d/magisk-extreme-vip' },
    ],
  },
  {
    id: 'prod-3',
    ...
    packages: [
      { id: 'pkg-3-1', name: 'GÓI 6 THÁNG', price: 129000, originalPrice: 180000, sellerPrice: 85000, keys: 'Cert P12 Gói 6T: https://drive.google.com/cert-6m' },
      { id: 'pkg-3-2', name: 'GÓI 1 NĂM (1 ĐỔI 1)', price: 199000, originalPrice: 300000, sellerPrice: 140000, keys: 'Cert P12 Gói 1 Năm: https://drive.google.com/cert-1y' },
      { id: 'pkg-3-3', name: 'GÓI TRỌN ĐỜI', price: 350000, originalPrice: 500000, sellerPrice: 240000, keys: 'Cert P12 VIP Trọn Đời: https://drive.google.com/cert-lifetime' },
    ],
  },
  {
    id: 'prod-4',
    ...
    packages: [
      { id: 'pkg-4-1', name: '1 GIỜ', price: 15000, originalPrice: 25000, sellerPrice: 10000, keys: 'Key 1 Giờ: FF-1H-882233' },
      { id: 'pkg-4-2', name: '1 NGÀY', price: 90000, originalPrice: 120000, sellerPrice: 60000, keys: 'Key 1 Ngày: FF-1D-445566' },
      { id: 'pkg-4-3', name: '7 NGÀY', price: 230000, originalPrice: 300000, sellerPrice: 160000, keys: 'Key 7 Ngày: FF-7D-778899' },
      { id: 'pkg-4-4', name: '1 THÁNG', price: 450000, originalPrice: 600000, sellerPrice: 320000, keys: 'Key 1 Tháng: FF-30D-MIGUL-VIP' },
    ],
  },
  {
    id: 'prod-5',
    ...
    packages: [
      { id: 'pkg-5-1', name: '1 NGÀY', price: 15000, originalPrice: 25000, sellerPrice: 10000, keys: 'Key 1 Ngày: TX-KEY-1D-1122' },
      { id: 'pkg-5-2', name: '7 NGÀY', price: 35000, originalPrice: 50000, sellerPrice: 22000, keys: 'Key 7 Ngày: TX-KEY-7D-3344' },
      { id: 'pkg-5-3', name: '30 NGÀY', price: 50000, originalPrice: 80000, sellerPrice: 35000, keys: 'Key 30 Ngày: THAN-OX-30D-AUTO-KEY-VALID' },
      { id: 'pkg-5-4', name: 'VĨNH VIỄN', price: 150000, originalPrice: 220000, sellerPrice: 100000, keys: 'Key Vĩnh Viễn: THAN-OX-PERMANENT-KEY' },
    ],
  },
  {
    id: 'prod-6',
    ...
    packages: [
      { id: 'pkg-6-1', name: '7 NGÀY', price: 20000, originalPrice: 30000, sellerPrice: 12000, keys: 'Proxy 7D: 103.149.28.115:8080:thanox:7d' },
      { id: 'pkg-6-2', name: '30 NGÀY', price: 35000, originalPrice: 60000, sellerPrice: 20000, keys: 'Proxy 30D: 103.149.28.115:8080:thanox:30d' },
      { id: 'pkg-6-3', name: '90 NGÀY', price: 95000, originalPrice: 150000, sellerPrice: 60000, keys: 'Proxy 90D: 103.149.28.115:8080:thanox:90d' },
    ],
  },
];
